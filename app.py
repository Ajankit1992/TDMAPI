...
def tdm_api_genrate():
	...
	if (content_type == 'application/json'):
		...
		database_connect, script_type, no_of_rows, columns_array = data['database-connect'], data['type'], data['rows'], data['mask-columns']
		helperLib.print_msg("INFO", "API Called successfully")
		json_df = main.tdm_api_genrate(database_connect, script_type, no_of_rows, columns_array)
